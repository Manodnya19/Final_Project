...
class _NewBlankPageState extends State<NewBlankPage> {
  ...
  void initState() {
    ...
    // Introduce a 5-second delay before fetching data
          ...
          child: Stack(
            children: [
              ...
              if (nutrients == null)
                Padding(
                  padding: EdgeInsets.symmetric(
                      vertical: 250.0), // Adjust the vertical padding
                  child: Center(
                    // Center the loading indicator
                    child: Image.network(
                      'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExN2hsbHEyNThzeHV4OHpmOTFpbGgzY2JnMGQ0d2h1eHpxcTNmaHAwOSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/mFYJc3SgMkL5DZXo5p/giphy.gif',
                      width: 200.0,
                      height: 200.0,
                    ),
                  ),
